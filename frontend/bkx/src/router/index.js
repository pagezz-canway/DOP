...
const EsAdd = () => import(/* webpackChunkName: 'add' */'@/views/es/add')
const EsReduce = () => import(/* webpackChunkName: 'reduce' */'@/views/es/reduce')
...
const HadoopAdd = () => import(/* webpackChunkName: 'none' */'@/views/hadoop/add')
const HadoopReduce = () => import(/* webpackChunkName: 'none' */'@/views/hadoop/reduce')
...
const KafkaAdd = () => import(/* webpackChunkName: 'add' */'@/views/kafka/add')
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        component: HadoopAdd,
                        meta: {
                            matchRoute: 'Hadoop集群扩容'
                        }
                    },
                    {
                        path: 'hadoopreduce',
                        name: 'hadoopreduce',
                        component: HadoopReduce,
                        meta: {
                            matchRoute: 'Hadoop集群缩容'
                        }
                    },
                    // {
                    //     path: 'hadooprule',
