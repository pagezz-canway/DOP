...
export default {
    ...
    actions: {
        ...
        */
        ...
        // const Url = `${AJAX_URL_PREFIX}v1/es/cluster/create?${AJAX_MOCK_PARAM}=index&invoke=createEsCluster&${queryString.stringify(params)}`
        ...
        listTopics (context, params, config = {}) {
            // mock 的地址，示例先使用 mock 地址
            // const Url = `${AJAX_URL_PREFIX}v1/es/cluster/list?${AJAX_MOCK_PARAM}=index&invoke=getEsData&${queryString.stringify(params)}`
