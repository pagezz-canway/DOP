...
def retrieval_hadoop_deploy_param(post_data, bk_username):
    ...
    hdfs_includes = post_data.get("hdfs_includes")
    hdfs_excludes = post_data.get("hdfs_excludes")
    data_disk_dir_list = str_trans_list(post_data.get("hdfs_dir", "/data/hadoop_data"))
    ...
    if hdfs_excludes == hdfs_includes:
